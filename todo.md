...
- [ ] Implementar experiência de edição estilo Canva com arrastar e soltar (drag-and-drop), posicionamento livre de imagens/logos, painel de gerenciamento de camadas (trazer para frente, enviar para trás) e exportação vetorizada em PDF em Fabric.js, Konva.js e GrapesJS.
