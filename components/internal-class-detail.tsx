...
type Summary = { sessions: Session[]; activities: Array<{ id: number; title: string; dueDate: string | Date | null }>; attendances: Array<{ studentId: number; status: string }>; averageProgress: number; attendanceRate: number; completedActivities: number; totalActivities: number };
