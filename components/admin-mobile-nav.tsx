...
import { BarChart3, BookOpen, FileSignature, Globe, LayoutDashboard, Users } from "lucide-react";
...
export function AdminMobileNav() {
  ...
  return (
    <nav className="admin-mobile-nav fixed inset-x-3 bottom-3 z-40 grid grid-cols-6 gap-1 rounded-2xl border border-border/80 bg-card/95 p-1.5 shadow-[0_18px_50px_rgba(15,23,42,0.18)] backdrop-blur-xl md:hidden" aria-label="Navegação administrativa mobile">
