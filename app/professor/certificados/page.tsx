...
export const metadata = {
  title: "Certificados e Assinaturas | Professor",
  description: "Emita, revise e envie certificados finais dos cursos sob sua gestão.",
};
      ...
      <div className="page-container space-y-8">
        <header className="surface-card flex flex-col gap-5 border border-border/70 p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="flex min-w-0 items-center gap-3 text-3xl font-black tracking-tight text-foreground sm:text-4xl"><FileSignature className="shrink-0 text-red-600" /> <span className="break-words">Certificados e assinaturas</span></h1>
            <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">Emita certificados, revise uma prévia do documento e envie a versão final assinada. A fila exibe somente cursos que você pode gerenciar.</p>
          </div>
