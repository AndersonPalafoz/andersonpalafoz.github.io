        ...
        <div className="bg-white py-8 px-4 shadow-sm border border-gray-200 sm:rounded-2xl sm:px-10 space-y-6">
          ...
          {!isEmailLogin ? (
            ...
            <form onSubmit={handleCredentialsLogin} className="space-y-4 animate-in fade-in">
              ...
              <div>
                <label className="block text-xs font-semibold uppercase text-gray-600 mb-1">Senha</label>
                <input
                  type="password"
                  required
                  value={password}
              ...
              <div className="pt-2 flex justify-between items-center text-xs">
                <button type="button" onClick={() => setIsEmailLogin(false)} className="text-gray-500 hover:underline">
                  Voltar às opções
                </button>
