...
export function ClassroomGradesNotificationBanner() {
  const [notices, setNotices] = useState<ClassroomGradeNotice[]>([
    {
      id: "cn1",
      courseTitle: "English Grammar Advanced (B2/C1)",
      activityTitle: "Quiz 03: Subjunctive Mood & Conditional Clauses",
      grade: "9.5 / 10.0",
      importedAt: "Hoje, 10:30"
    },
    {
      id: "cn2",
      courseTitle: "Conversational Fluency & Speaking",
      activityTitle: "Gravação de Pronúncia - Módulo 1",
      grade: "10.0 / 10.0",
      importedAt: "Ontem, 16:45"
    }
  ]);
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-white/90">O professor sincronizou novas avaliações diretamente da sua turma do Google Sala de Aula.</p>
          </div>
        </div>
